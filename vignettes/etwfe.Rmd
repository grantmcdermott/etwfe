...
Or, if you prefer to use a dedicated fixed effects / panel data package like 
**fixest**, you could estimate:
...
It seems that the teen disemployment effect from a minimum wage hike is fairly
modest at first, but grows over time. In the next section, we'll look at ways to
present this kind of finding to your audience.
...
The point estimates might lead us to think that a minimum wage hike causes less
teen disemployment in GLS counties than in the rest of the US on average.
