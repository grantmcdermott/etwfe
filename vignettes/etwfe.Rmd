...
A canonical research designs for social scientists is the so-called
...
This type of regression is intuitive and easy to run, and for a long time
...
treatment was staggered over time (a very common occurrence).
...
For vizualization, you can pass in on to your preferred plotting method. For example:
