...
things, the core TWFE result is very likely to be biased in the presence of 
staggered treatment rollout (a common occurrence).
...
Thinking again about the **etwfe** workflow as a pair of consecutive functional
...
too deep into the weeds, the numerical delta method being used to recover the
...
prior to estimating the marginal effects can yield substantial speed gains of
