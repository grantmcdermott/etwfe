...
- [Jeffrey Wooldridge](http://econ.msu.edu/faculty/wooldridge/) for the underlying [ETWFE](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3906345) [theory](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4183726).
- [Laurent Bergé](https://sites.google.com/site/laurentrberge/) ([**fixest**](https://lrberge.github.io/fixest/)) and [Vincent Arel-Bundock](https://arelbundock.com/) ([**marginaleffects**](https://vincentarelbundock.github.io/marginaleffects/)) for maintaining the two wonderful R packages that do most of the heavy lifting under the hood here.
